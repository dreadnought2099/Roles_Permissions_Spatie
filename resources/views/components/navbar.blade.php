    ...
    <div class="container mx-auto px-6">
        <div class="flex justify-between items-center">
            ...
            <ul class="hidden lg:flex space-x-8 text-white text-lg ml-auto">
                ...
                <li><a href="{{ route('contact') }}" class="hover-underline transition duration-200">Contact</a></li>
                <li><a href="{{ route('transaction') }}" class="hover-underline transition duration-200">Transaction</a></li>
            </ul>
